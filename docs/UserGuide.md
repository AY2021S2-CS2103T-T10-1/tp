...
Action | Format
--------|------------------
**Add** | 1. `add dog n/DOGNAME b/BREED d/DATEOFBIRTH s/SEX o/OWNERID t/TAG`<br>2. `add owner n/OWNERNAME p/PHONE_NUMBER e/EMAIL a/ADDRESS`<br>3. `add  program n/PROGRAMNAME t/TIME`
